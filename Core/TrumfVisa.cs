    ...
    public class TrumfVisa : ParserBase
    {
        ...
        public override IEnumerable<Trasaction> GetTransactions()
        {
            ...
            foreach (var line in Content)
            {
                ...
                if (z.Success)
                {
                    var recordDate = DatePattern.Parse(z.Groups[1].Value).Value;

                    var transactionDate = new LocalDate(
                        recordDate.Year,
                        int.Parse(z.Groups[4].Value),
                        int.Parse(z.Groups[3].Value));
                    ...
                    list.Add(new Trasaction
                    {
                        ...
                        Amount = -decimal.Parse(z.Groups[5].Value)
                    });
                ...
                if (z.Success)
                {
                    ...
                    transaction.CurAmount =
                        -decimal.Parse(z.Groups[2].Value, CultureInfo.InvariantCulture.NumberFormat);
                }
            }
